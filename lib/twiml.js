...
// Words to bias Twilio's speech recognition toward (improves Bangla accuracy).
export const SPEECH_HINTS =
  "খাবার,খিদে,ডাক্তার,অসুস্থ,জ্বর,ঔষধ,থাকার জায়গা,আশ্রয়,কাপড়,কম্বল,টাকা,আর্থিক সাহায্য,বয়স্ক ভাতা,বিধবা ভাতা,প্রতিবন্ধী ভাতা,হাসপাতাল,জরুরি,টিকা,আঞ্জুমান মুফিদুল ইসলাম,সোহরাওয়ার্দী হাসপাতাল,মেরি স্টোপস";

// A <Gather> that plays a Bangla prompt and listens for Bangla speech.
// speechTimeout=3 (wait 3s of silence) + hints improve recognition vs "auto".
